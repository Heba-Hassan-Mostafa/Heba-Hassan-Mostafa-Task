    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('words.role-show') }} </span>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ trans('words.role-show') }}</h4>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                font-size: 18px;
                                color: #03aad7;">{{ trans('words.role-name') }}:</strong>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <strong
                                style="font-weight: bold;
                            font-size: 18px;
                            color: #03aad7;">:{{ trans('words.permissions') }}</strong>
