    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('words.create-user') }}</span>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ trans('words.create-user') }}</h4>
                        ...
                        <div class="col-4">
                            <div class="form-group d-flex">
                              ...
                              <div class="d-inline-block">
                                <div>
                                    <input type="radio" name="is_admin" value="0" > Client
                                  </div>
                                  <div>
